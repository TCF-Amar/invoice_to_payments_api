...
import * as cashfreePayoutCtrl from '../controllers/cashfree.controller.js';
...
// ════════════════════════════════════════════════════
// POST   /api/v1/payouts/cashfree/setup-beneficiary     → setup Cashfree beneficiary
// GET    /api/v1/payouts/cashfree/beneficiary/:vendorId  → get beneficiary details
// POST   /api/v1/payouts/cashfree                       → initiate Cashfree transfer
// GET    /api/v1/payouts/cashfree/status/:transferId    → get transfer status

router.post('/payouts/cashfree/setup-beneficiary', cashfreePayoutCtrl.setupCashfreeBeneficiary);
router.get('/payouts/cashfree/beneficiary/:vendorId', cashfreePayoutCtrl.getCashfreeBeneficiaryDetails);
router.post('/payouts/cashfree', cashfreePayoutCtrl.createCashfreePayout);
router.get('/payouts/cashfree/status/:transferId', cashfreePayoutCtrl.getCashfreeTransferStatus);
